  ...
  async checkS3Connection() {
    try {
      ...
      return {
        ...
        bucket: result.signedUrl.includes('safedocs-storage-bucket')
          ? 'safedocs-storage-bucket'
          : 'unknown',
      ...
      return {
        ...
        message: error.message,
        details:
          'Failed to connect to S3. Check your AWS credentials and bucket configuration.',
      };
    }
  }
}
